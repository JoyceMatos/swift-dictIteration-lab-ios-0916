 ...
 */
var highestSellingAlbum = ["Nirvana": "Nevermind", "Blondie": "Parallel Lines", "The Kinks": "Low Budget", "The Beatles": "Sgt. Pepper's Lonely Hearts Club Band"]
 ...
 */
highestSellingAlbum["Pixie"] = "Doolittle"
...
let album = highestSellingAlbum[bandName]

if let album = album {
    print("The capital of \(bandName) is \(album)") }
 ...
 * Grade 12: B
 */
var examResults = [9: "B",10: "A", 11: "C", 12: "B"]
